            ...
            while (true) {
                ...
                if (pain != null) {
                    ...
                    if (pain == Pain.PAIN_EMPOISONNE) {
                        ...
                        System.out.println(STR."[\{Thread.currentThread().getName()}][\{boulangerie.getStock()}] miam miam") ;
                    }

                }  else {
                    System.out.println(STR."[\{Thread.currentThread().getName()}][\{boulangerie.getStock()}] j'ai faim") ;
                }
            }
